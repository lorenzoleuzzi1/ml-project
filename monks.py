...
# net = Network(activation_out='tanh', epochs= 1000, batch_size=1, learning_rate="linear_decay", learning_rate_init=0.002)
...
# print(accuracy(y_true=y_test, y_pred=flattened_pred))